    ...
    <div className="flex flex-col gap-8">
      {description && (
        <div>
          ...
          <p className="text-sm leading-relaxed max-w-3xl" style={{ color: 'var(--adm-muted)' }}>{description}</p>
        </div>
      )}
      ...
      {materialsNeeded && (
        <div>
          ...
          <p className="text-sm leading-relaxed max-w-3xl" style={{ color: 'var(--adm-muted)' }}>{materialsNeeded}</p>
        </div>
      )}
    </div>
  );
